...
function preload(){
  ...
  loadFont('assets/fonts/BemboStd-Semibold.otf');
  loadFont('assets/fonts/BemboStd.otf');
...
labelP01.style("font-size","15pt"); 
labelP01.style("font-family", "BemboStd-Semibold"); 
labelP01.style('color', '#000000');
labelP01.style('padding-top', '29%');
labelP01.style('padding-left', '6%');

labelP01.position(0, 0);
//labelP01.style('transform', 'rotate(90deg)');

labelP02 = createP(" "); 
  
labelP02.style("font-size","15pt"); 
labelP02.style("font-family", "BemboStd"); 
labelP02.style('text-align', 'justify');
labelP02.style('text-justify', 'inter-word');
labelP02.style('line-height', '1.4');
labelP02.style('padding-top', '43%');
labelP02.style('padding-left', '6%');
labelP02.style('padding-right', '6%');
...
{
  KNNdescr = "Printed Matter"
  description = text03
}
else if (KNNresult == 5)
{
  KNNdescr = " Fleamarket applied"
  description = text04
  push();
...
{
  KNNdescr = "Proxemics: Intimate Zone"
  description = text14
}
else if (KNNresult == 15)
{
  KNNdescr = "Proxemics in Language"
  description = text15
}
else if (KNNresult == 16)
{
  KNNdescr = "Proxemics Gaze"
  description = text16
